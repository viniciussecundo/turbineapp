...
### Épico C — Onboarding (total ~13 SP)
1. **C1 — Criar organização + admin** (5 SP)  
   - fluxo de signup inicial.
2. **C2 — Convites por e‑mail** (4 SP)  
   - criação e aceite de convite.
3. **C3 — Aceite de convite + role** (4 SP)  
   - criação de usuário + role.

### Épico D — Auditoria e segurança (total ~10 SP)
1. **D1 — Audit log** (4 SP)  
   - registrar ações críticas (CRUD financeiro).
2. **D2 — Rate limit / proteção login** (3 SP)
3. **D3 — Alertas de segurança** (3 SP)
